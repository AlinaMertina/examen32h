          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap" style="width:200px;height:200px;">
              ...
              <div class="portfolio-info">
                ...
                <?php if(!isset($gestion)){ ?><a href="<?php echo base_url("redirectform/fairepropositon/?idproduit=".$idp[$i]."&&iduser=".$idUser[$i]);?>" ><i class="bx bx-plus"></i></a><?php }?>
                  <?php if(isset($gestion)){ ?>
                    <a href="<?php echo base_url("accuille/modifcategorie/?idproduit=".$idp[$i]);?>" title="More Details"><i class="bx bx-link"></i></a> 
                    <a href="<?php echo base_url("accuille/listehistoriqueObjet/?idproduit=".$idp[$i]);?>" title="More Details">historique</a> 
                    <?php }?>
                </div>
              </div>
            </div>
