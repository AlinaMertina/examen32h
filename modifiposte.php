...
<body>
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div id="image">
        <?php for($i=0;$i<count($Nomimage);$i++){ ?>
                        <img src="<?php echo base_url("assets/image/".$Nomimage[$i]); ?>" width="200" height="200">
                    <?php } ?>
        </div>
        <div class="wrapper wrapper--w780" style="margin-top:-10%; ">
            <div class="card card-3">
                <div class="card-heading" style="backgound-color:white;" >
                   
                </div>
                <div class="card-body">
                    <h2 class="title">Modif</h2>
                    <form method="POST" action="<?php echo base_url(""); ?>">
                        <div class="input-group">
                            <label style="color:white;" >Description</label>
                            <input class="input--style-3" type="text" placeholder="Description" name="description" value="<?php echo $desc;?>">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="input--style-3" type="number" placeholder="Prix estimatif" name="prix" value="<?php echo $prix;?>">
                        </div>
                        <div class="p-t-10">
