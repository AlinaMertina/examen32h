  ...
  <section id="hero" class="d-flex align-items-center" style="">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Bienvenu Dans Takalo-Takolo</h1>
      <h2>Fanakalozanjavatra Azo antoka sy mirary</h2>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <img src="<?php echo base_url("assets/image/".$Nomimage[$i]);?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?php echo $prix[$i]; ?></h4>
                <p><?php echo $description[$i]; ?></p>
                <div class="portfolio-links">
                  <a href="<?php echo base_url("assets/image/".$Nomimage[$i]);?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
      ...
      <?php for($i=0;$i<count();$i++){ ?>
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <img src="<?php echo base_url("assetsT/img/testimonials/testimonials-1.jpg"); ?>" class="testimonial-img" alt="">
                    <h3>Saul Goodman</h3>
                    <h4>Ceo &amp; Founder</h4>
                  </div>
