	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url('assets/images/bg-01.jpg'); ?>');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form"  action="<?php echo base_url('welcome/traitLogin/') ?>" method = "post">
					...
					<div class="flex-col-c p-t-155">                  
						<a href="<?php echo base_url('welcome/inscription'); ?>" class="txt2">
							Creer un compte
						</a>
                        <a href="<?php echo base_url('welcome/admin/'); ?>" class="txt2">
							se connecter en tanqu'admint 
						</a>
					</div>
				</form>
			</div>
